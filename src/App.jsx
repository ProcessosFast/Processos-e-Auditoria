...
function AreaModal({ open, onClose, modulos, area, onSave }) {
  ...
  const categOptions = ["Administrativo","Setor Técnico","Comercial Varejo","Comercial Atacado","Comercial Homes e Obras","Faturamento","Franquias","Financeiro / Admin","Operações","Suporte","Controle"];
